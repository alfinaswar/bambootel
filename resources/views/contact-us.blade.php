...
<head>
    <title>Shared on THEMELOCK.COM - Residem - Single Property Website Template</title>
...
<body>
    ...
    <div id="wrapper">
                    ...
                    <div class="col-lg-12">
                        <div class="de-flex">
                            ...
                            <div class="col-center">
                                <a href="02_apartment-homepage-1.html"><img src="images/logo.webp" alt=""></a>
                            </div>
                            <div class="col-end">
                                <div class="menu_side_area">
                                    <a href="02_apartment-contact.html"
        ...
        <section id="section-hero"
            ...
            <img src="https://images.pexels.com/photos/237272/pexels-photo-237272.jpeg" class="jarallax-img" alt="">
                        ...
                        <div class="col-lg-12">
                            <div class="relative overflow-hidden">
                                <div class="wow fadeInUpBig" data-wow-duration="1.5s">
                                    <h1 class="fs-120 text-uppercase fs-sm-10vw mb-2 lh-1">Schedule a Visit</h1>
                                    <h3>We’ll Be Happy to Show You Around!</h3>
                                </div>
                            </div>
                        </div>
                    </div>
